    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
        ...
        <section class="panel">
            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0" id="assetData" data-searchable-table><thead><tr><th>Order</th><th>Product</th><th>Customer</th><th>Status</th><th>Amount</th><th>Date</th><th class="text-end">Action</th></tr></thead>
                    <tbody id="assetList">
